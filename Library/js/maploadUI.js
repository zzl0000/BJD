	...
	! function() {
				...
				function newContext(e) {
					...
					function a(e, t, n, i) {
						var a, s, u, c, f = null,
							...
							l = !0,
							h = "";
						return e || (l = !1, e = "_@r" + (C += 1)), c = o(e), f = c[0], e = c[1], f && (f = r(f, p, i), s = getOwn(k, f)), e && (f ? h = s && s.normalize ? s.normalize(e, function(e) {
							return r(e, p, i)
						}) : e.indexOf("!") === -1 ? r(e, p, i) : e : (h = r(e, p, i), c = o(h), f = c[0], h = c[1], n = !0, a = q.nameToUrl(h))), u = !f || s || n ? "" : "_unnormalized" + (T += 1), {
							prefix: f,
							name: h,
							parentMap: t,
							unnormalized: !!u,
					...
					return y = {
						...
						exports: function(e) {
							if(e.usingExports = !0, e.map.isDefine) return e.exports ? k[e.map.id] = e.exports : e.exports = k[e.map.id] = {}
						},
						module: function(e) {
						...
						this.events = getOwn(A, e.id) || {}, this.map = e, this.shim = getOwn(w.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0
					}, b.prototype = {
						...
						callPlugin: function() {
							...
							this.depMaps.push(n), u(n, "defined", bind(this, function(n) {
								...
								})), f = getOwn(M, o.id), void(f && (this.depMaps.push(o), this.events.error && f.on("error", bind(this, function(e) {
									this.emit("error", e)
								})), f.enable()))) : d ? (this.map.url = q.nameToUrl(d), void this.load()) : (i = bind(this, function(e) {
									this.init([], function() {
										return e
									}, null, {
										enabled: !0
						...
						makeRequire: function(t, i) {
							function o(r, n, u) {
								...
								return i.enableBuildCallback && n && isFunction(n) && (n.__requireJsBuild = !0), "string" == typeof r ? isFunction(n) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(y, r) ? y[r](M[t.id]) : req.get ? req.get(q, r, t, o) : (p = a(r, t, !1, !0), f = p.id, hasProp(k, f) ? k[f] : c(makeError("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), q.nextTick(function() {
									v(), d = s(a(null, t)), d.skipMap = i.skipMap, d.init(r, n, u, {
										enabled: !0
									}), l()
								}), o)
							}
							return i = i || {}, mixin(o, {
								...
								specified: function(e) {
									return e = a(e, t, !1, !0).id, hasProp(k, e) || hasProp(M, e)
								}
							}), t || (o.undef = function(e) {
								f();
								var r = a(e, t, !0),
									i = getOwn(M, e);
								i.undefed = !0, n(e), delete k[e], delete j[r.url], delete A[e], eachReverse(O, function(t, r) {
									t[0] === e && O.splice(r, 1)
								}), delete q.defQueueMap[e], i && (i.events.defined && (A[e] = i.events), p(e))
							}), o
						},
						enable: function(e) {
							var t = getOwn(M, e.id);
						...
						nameToUrl: function(e, t, r) {
							...
							if(req.jsExtRegExp.test(e)) s = e + (t || "");
								...
								for(n = w.paths, i = e.split("/"), o = i.length; o > 0; o -= 1)
									if(a = i.slice(0, o).join("/"), u = getOwn(n, a)) {
		...
		var o, a, s, u = function() {
			...
			d = function() {
				s();
				var e = f.shift();
				return e ? (s = e[1], void p(e[0])) : void(s = null)
			},
			l = function(e, t) {
			...
			h = function(t, r) {
				...
				if(i.type = "text/css", i.rel = "stylesheet", n) i.onload = function() {
					i.onload = function() {}, setTimeout(r, 7)
				};
		...
		return {
			...
			normalize: function(e, t) {
				return e.indexOf(CACHE_BUST_FLAG) !== -1 && (e = cacheBust(e)), t(e)
			},
